      ...
      <main className="px-6 space-y-10">
        ...
        <section className="space-y-4">
          <div className="flex flex-col">
            ...
            <p className="text-[10px] text-neutral-355 font-mono">Frosted glassmorphism, 3D springs, and masked sweeps</p>
          </div>
        ...
        <section className="space-y-4">
          <div className="flex flex-col">
            ...
            <p className="text-[10px] text-neutral-355 font-mono">Staggered cascades vs. dynamic audio waveforms</p>
          </div>

          <div className="space-y-6">
            
            {/* 12. Cascade Progress Bar (Boot-up) */}
            <div className="p-4 border border-neutral-855 bg-neutral-950 rounded-lg space-y-4">
        ...
        <section className="space-y-4">
          <div className="flex flex-col">
            ...
            <p className="text-[10px] text-neutral-355 font-mono">Elastic spring checkpoints and dynamic strike sweeps</p>
          </div>
        ...
        <section className="space-y-4">
          <div className="flex flex-col">
            ...
            <p className="text-[10px] text-neutral-355 font-mono">Scroll the simulator to see dynamic header padding adapt</p>
          </div>

          {/* 17. Device frame mockup */}
          <div className="border border-neutral-855 bg-black rounded-xl overflow-hidden shadow-2xl relative max-w-sm mx-auto select-none">
            ...
            >
              ...
              <span className="text-[7px] font-mono text-neutral-300 uppercase tracking-widest flex items-center gap-1.5">
                ...
                <span className="text-white bg-neutral-900 px-1 py-0.5 rounded border border-neutral-855">
        ...
        <section className="space-y-4">
          <div className="flex flex-col">
            ...
            <p className="text-[10px] text-neutral-355 font-mono">Attract user visual focus dynamically in dark themes</p>
          </div>
        ...
        <section className="space-y-4">
          <div className="flex flex-col">
            ...
            <p className="text-[10px] text-neutral-355 font-mono">Tactile sheets sliding with programmatic elastic rebounds</p>
          </div>
        ...
        <section className="space-y-4">
          <div className="flex flex-col">
            ...
            <p className="text-[10px] text-neutral-355 font-mono">Mechanical rotating arc wheel menu for fluid views transition</p>
          </div>
            ...
            <div className="space-y-2.5">
              ...
              <div className="p-3 bg-black border border-neutral-900 rounded-lg flex items-center justify-between text-[10px] font-mono text-neutral-200">
                ...
                <span className="flex items-center gap-1.5">
                  ...
                  <span className="text-[8px] bg-neutral-900 px-1.5 py-0.5 rounded border border-neutral-855 text-neutral-350 font-bold uppercase font-mono">UPGRADE #20</span>
                </span>
              </div>
            </div>
          </div>
