    ...
    <div className="min-h-screen bg-black text-white md:max-w-md md:mx-auto md:shadow-2xl md:border-x md:border-neutral-900 pb-28 relative flex flex-col overflow-hidden">
      ...
      <header className={`fixed top-0 left-0 right-0 mx-auto z-40 w-full md:max-w-md bg-[#0d0d0d]/80 backdrop-blur-md border-b transition-all duration-300 ease-out flex items-center justify-between ${
        ...
        <div className={`flex items-center gap-2 select-none transition-transform duration-300 ease-out origin-left ${
          ...
          <AetherLogo />
          <span className="text-[7px] font-mono border border-neutral-800 bg-neutral-950 px-1 py-0.5 rounded text-neutral-400 select-none tracking-normal">
            TEST MODE
          </span>
        </div>
        ...
        <div className={`flex items-center gap-2.5 transition-transform duration-300 ease-out origin-right ${
          ...
          <span className="text-[10px] uppercase font-mono tracking-widest text-neutral-300 hidden sm:inline-block mr-1.5">
            {user === "guest" ? "Guest Sandbox" : user?.email?.split("@")[0] || "Tester"}
          </span>
          <button
            onClick={() => {
      ...
      <main className="flex-1 px-6 pt-24 pb-6 space-y-6">
        ...
        <div className="flex items-center gap-3 p-4 border border-neutral-900 bg-neutral-950/40 rounded-lg select-none">
          ...
          <p className="text-[10px] font-mono text-neutral-200 tracking-wide leading-relaxed">
            &quot;Aether Test Playground&quot; — Reordering and filter features active here as well.
          </p>
        </div>
